...
function afficherMenu_prof() {
    ...
    switch (choix) {
        ...
        default:
            ...
            afficherMenu_prof(); // Afficher à nouveau le menu en cas de choix invalide
            break;
    }
}
...
function fonctionOption1() {
    ...
    afficherMenu_prof(); // Retourner au menu principal
}
